...
Requires Meilisearch 1.16 or later. Sorted document pagination is reliable from 1.27;
earlier servers may duplicate or omit documents across batches (see https://github.com/meilisearch/meilisearch/issues/5943[upstream issue #5943]).
