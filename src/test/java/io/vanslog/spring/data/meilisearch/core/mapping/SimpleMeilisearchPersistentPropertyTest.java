...
class SimpleMeilisearchPersistentPropertyTest {
  ...
  void shouldReturnFieldName() {
    ...
    SimpleMeilisearchPersistentProperty idProperty = (SimpleMeilisearchPersistentProperty) entity.getPersistentProperty("id");
    SimpleMeilisearchPersistentProperty titleProperty = (SimpleMeilisearchPersistentProperty) entity.getPersistentProperty("title");
    SimpleMeilisearchPersistentProperty descriptionProperty = (SimpleMeilisearchPersistentProperty) entity.getPersistentProperty("description");
    SimpleMeilisearchPersistentProperty genresProperty = (SimpleMeilisearchPersistentProperty) entity.getPersistentProperty("genres");
