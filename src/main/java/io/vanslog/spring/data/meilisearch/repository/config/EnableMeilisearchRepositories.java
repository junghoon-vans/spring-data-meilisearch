 ...
 * {@link org.springframework.data.repository.config.AnnotationRepositoryConfigurationSource}
...
public @interface EnableMeilisearchRepositories {
    ...
    /**
     * Returns the {@link io.vanslog.spring.data.meilisearch.core.MeilisearchTemplate} bean name.
     * This name will be used to create Meilisearch repositories discovered through this annotation.
     * Defaults to {@code  meilisearchTemplate}.
     *
     * @return String
     */
