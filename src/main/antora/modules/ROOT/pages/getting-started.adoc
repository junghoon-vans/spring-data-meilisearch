...
* Read xref:meilisearch/object-mapping.adoc[object mapping] to understand `@Document`, `@Setting`, and conversion support.
* Read xref:meilisearch/template.adoc[operations] and xref:repositories.adoc[repositories] to choose between template-style access and repository abstractions.
