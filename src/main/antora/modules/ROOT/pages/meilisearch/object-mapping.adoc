...
Use annotation-driven settings for stable, entity-owned index defaults that should travel with the mapped type.
Use xref:meilisearch/settings.adoc[runtime settings operations] when settings must be inspected or adjusted dynamically.
