...
For production deployments, prefer a scoped API key rather than the Meilisearch master key.
...
The XML namespace attributes are documented in xref:appendix.adoc#meilisearch.appendix.schema[XML namespace reference].
