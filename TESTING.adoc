...
The minimum supported Meilisearch release is `v1.16.0`.
`SortableMeilisearchRepositoryIntegrationTests` uses `v1.27.0`, the first release with reliable
sorted document pagination across batches.
